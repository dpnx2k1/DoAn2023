...
<?php  
    if($curren_page>1){
        $prev=$curren_page-1;?>
    <a href="<?php echo'category.php?brand_id='.$_GET['brand_id'].''; ?>&<?=$param?>item_per_page=<?=$item_per_page?>&page=<?=$prev?>"> 
...
<?php 
 for ($num=1; $num <= $total_page; $num++) { ?>
  <?php  if ($num!=$curren_page) { 
    ...
    ?>
    <a href="<?php echo'category.php?brand_id='.$_GET['brand_id'].''; ?>&<?=$param?>item_per_page=<?=$item_per_page?>&page=<?=$num?>"> 
...
<?php  
    if($curren_page<$total_page){
        $next=$curren_page+1;?>
    <a href="<?php echo'category.php?brand_id='.$_GET['brand_id'].''; ?>&<?=$param?>item_per_page=<?=$item_per_page?>&page=<?=$next?>"> 
...
<?php 
    if ($curren_page < $total_page-3) {
        $end=$total_page;
    ?>
     <a href="<?php echo'category.php?brand_id='.$_GET['brand_id'].''; ?>&<?=$param?>item_per_page=<?=$item_per_page?>&page=<?=$end?>"> 
